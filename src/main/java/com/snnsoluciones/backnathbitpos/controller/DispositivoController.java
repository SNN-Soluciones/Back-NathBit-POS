 ...
 * - POST /api/dispositivos/registrar - Registrar nuevo PDV con token
 * 
 * Endpoints con device token (header X-Device-Token):
 * - GET /api/dispositivos/usuarios - Lista usuarios del dispositivo
 * 
 * Endpoints admin (requieren JWT):
 * - POST /api/admin/dispositivos/generar-token - Genera token de registro
 * - GET /api/admin/dispositivos/empresa/{empresaId} - Lista dispositivos
 * - PUT /api/admin/dispositivos/{id}/activar - Activa dispositivo
 * - PUT /api/admin/dispositivos/{id}/desactivar - Desactiva dispositivo
 */
@RestController
@RequestMapping("/api")
...
public class DispositivoController {
    ...
    public ResponseEntity<ApiResponse<RegistrarDispositivoResponse>> registrarDispositivo(
        ...
        try {
            ...
            RegistrarDispositivoResponse response = dispositivoService.registrarDispositivo(request, ipCliente);
    ...
    public ResponseEntity<ApiResponse<DispositivoUsuariosResponse>> obtenerUsuarios(
        ...
        try {
            DispositivoUsuariosResponse response = dispositivoService.obtenerUsuariosDispositivo(deviceToken);
    ...
    public ResponseEntity<ApiResponse<List<DispositivoDTO>>> listarDispositivos(
        ...
        try {
            List<DispositivoDTO> dispositivos = dispositivoService.listarDispositivosPorEmpresa(empresaId);
