...
public class ProductoCompuestoV2ServiceImpl implements ProductoCompuestoV2Service {
    ...
    private SlotV2 crearSlot(
        ...
        SlotV2 slot = SlotV2.builder()
            ...
            .permiteCantidadPorOpcion(request.getPermiteCantidadPorOpcion() != null ? request.getPermiteCantidadPorOpcion() : false)
            .maxTiposDiferentes(request.getMaxTiposDiferentes())
    ...
    private SlotV2Dto convertirSlotADto(SlotV2 slot) {
        return SlotV2Dto.builder()
            ...
            .maxTiposDiferentes(slot.getMaxTiposDiferentes())
            .orden(slot.getOrden())
