...
public class ProductoImportServiceImpl implements ProductoImportService {
  ...
  @Override
  @Transactional
  public ProductoImportResultDto importarProductos(Long empresaId,
    ...
    for (ProductoImportDto productoImport : productos) {
      try {
        ...
        sucursalId = productoImport.getSucursalId() != null ? productoImport.getSucursalId() : null;
    ...
    Sucursal sucursalImportacion = modularHelper.determinarSucursalParaEntidad(empresaId, sucursalId,
        "producto");
    ...
    for (int i = 0; i < productos.size(); i++) {
      ...
      try {
        ...
        if (productoExistente.isPresent()) {
          ...
          if (productoImport.getCodigoBarras() != null && !productoImport.getCodigoBarras()
              .isEmpty()) {
